document.addEventListener('DOMContentLoaded', function() {
  // var controlLeft = document.querySelector('.-two .slider-control');
  var control = document.querySelector('.slider-control');  

  // var textWidth = document.querySelector('.text-slider').offsetWidth + 2;
  var photoWidth = document.querySelector('.image-slider').offsetWidth + 2;

  // var textItems = [].slice.call(document.querySelectorAll('.text-slider__item'));
  var photoItems = [].slice.call(document.querySelectorAll('.image-slider li'));

  // var textSliderContent = document.querySelector('.text-slider__list');
  var photosSliderContent = document.querySelector('.image-slider ul');

  // var textSliderWidth = -(5 * textWidth - textWidth);
  var photosSliderWidth = -(2 * photoWidth - photoWidth);
  ...
  //   photoWidth = document.querySelector('.-two .image-slider').offsetWidth;
  //   addSize();
  // });
  // window.addEventListener('resize', function() {
  //   var x = activeSlide;
  ...
  function slide(activeSlide, control) {
    ...
    var timer = setInterval(function() {
      ...
      draw(timePassed, photoPosition, control);
    }, 1);
  }

  function draw(timePassed, photoPosition, control) {
